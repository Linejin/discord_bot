...
async def tts(ctx, *args):
    ...
    if ctx.author.id == 153512604323676160:
            voiceType = '"WOMAN_DIALOG_BRIGHT"'
    if ctx.author.id == 338541947142537217 or ctx.author.id == 344150770616369153 or ctx.author.id == 413166258289377281:
            voiceType = '"MAN_DIALOG_BRIGHT"'
...
@bot.command(aliases = ["checkmission", "CheckMission", "CHECKMISSION"])
